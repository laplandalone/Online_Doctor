...
import com.yx.online.model.HospitalManagerT;
...
public class UserPasswordActivity extends BaseActivity {
	...
	private HospitalManagerT managerT;
	...
	public void submit(View v)
	{
		...
		managerT=new HospitalManagerT();
		this.managerT.setManagerId(user.getManager_id());
		this.managerT.setPassword(pswStr);
		Gson gson = new Gson();
		String updateUserStr = gson.toJson(managerT);
		RequestParams param = webInterface.updateManager(updateUserStr);
